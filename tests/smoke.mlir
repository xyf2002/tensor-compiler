...
func.func @test_matmul(%a: tensor<4x8xf32>, %b: tensor<8x16xf32>) -> tensor<4x16xf32> {
  // CHECK: linalg.matmul
  %0 = tensor.matmul %a, %b : tensor<4x8xf32>, tensor<8x16xf32> -> tensor<4x16xf32>
...
func.func @test_relu(%x: tensor<4x4xf32>) -> tensor<4x4xf32> {
  ...
  %0 = tensor.relu %x : tensor<4x4xf32> -> tensor<4x4xf32>
...
func.func @test_add(%a: tensor<4x4xf32>, %b: tensor<4x4xf32>) -> tensor<4x4xf32> {
  // CHECK: linalg.add
  %0 = tensor.add %a, %b : tensor<4x4xf32>, tensor<4x4xf32> -> tensor<4x4xf32>
  func.return %0 : tensor<4x4xf32>
}
